...
//https://i0.wp.com/cdnssl.ubergizmo.com/wp-content/uploads/2020/03/zoom-2.jpg
        ...
        <div className='courses-line d-flex align-items-center course-line-body justify-content-start w-50 text-start'>
          <div className='bg-transparent m-5'>
            ...
            <div className='w-75 d-flex justify-content-center'>
              <button className='btn btn-primary m-2 fs-4'>Get Started</button>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className='bg-white rounded-3 tutor-card'>
              <div>
                <div className='tutor-card-img d-flex justify-content-center'>
                  <img src='https://www.lingoda.com/wp-content/webp-express/webp-images/uploads/2022/05/tw-teacher-slider-dani.png.webp'
                      className='w-100 rounded-circle'></img>
                </div>
                <h4 className='m-3'>Marina Monro</h4>
                <div className='d-flex'>
                  <b>Where I am from:</b>
                  <div className='ms-2'>Chicago, USA</div>
                </div>
              </div>
            </div>
